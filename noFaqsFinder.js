...
async function processUrls() {
    try {
        ...
        // Define headers
        worksheet.columns = [
            { header: 'Request URL', key: 'requestUrl', width: 30 },
            { header: 'Publish Date', key: 'publishDate', width: 15 },
            { header: 'Author Name', key: 'authorName', width: 20 },
            // { header: 'Post Content', key: 'postContent', width: 30 },
            { header: 'External Link URL', key: 'externalLinkUrl', width: 30 },
            { header: 'External Link Text', key: 'externalLinkText', width: 30 },
            { header: 'Internal Link URL', key: 'internalLinkUrl', width: 30 },
            { header: 'Internal Link Text', key: 'internalLinkText', width: 30 },
            ...
            const addLinkRows = (links, isExternal) => {
                links.forEach((link) => {
                    worksheet.addRow({
                        ...
                        postContent: !firstRowAdded ? data.postContent : null,
